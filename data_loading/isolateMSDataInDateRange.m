function moodSwipeOut = isolateMSDataInDateRange(moodSwipe, startDate, varargin)
% 
% Overview
%	Returns MS data between start and end dates.
% 
...
idxWithinDateRange = find(moodSwipe.t >= startDate & moodSwipe.t < endDate);

% Isolate just the values within the date range, and save to output variables
moodSwipeOut.t = moodSwipe.t(idxWithinDateRange);
moodSwipeOut.val = moodSwipe.val(idxWithinDateRange);
