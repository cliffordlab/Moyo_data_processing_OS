function phq9Out = isolatePHQ9DataInDateRange(phq9, startDate, varargin)
% 
% Overview
%	Returns phq9 data between start and end dates.
% 
...
idxWithinDateRange = find(phq9.t >= startDate & phq9.t < endDate);

% Isolate just the values within the date range, and save to output variables
phq9Out.t = phq9.t(idxWithinDateRange);
phq9Out.val = phq9.val(idxWithinDateRange);
