function moodZoomOut = isolateMZDataInDateRange(moodZoom, startDate, varargin)
% 
% Overview
...
idxWithinDateRange = find(moodZoom.t >= startDate & moodZoom.t < endDate);

% Isolate just the values within the date range, and save to output variables
moodZoomOut.t = moodZoom.t(idxWithinDateRange);
moodZoomOut.val = moodZoom.val(idxWithinDateRange);
